...
<body id="main">
    <div id="left">
        <form action="SaveAction" id="info">
            ...
            <br/>
           	 图片/卡片链接：<input type="text" name="cardImage" id="cardImage" value='images/20180525012410682.jpg'>
        ...
        <c:if test="${requestScope.noteMap!=null }">
            <form  action='ModifyNote?www=${requestScope.noteMap.get("WWW")}&userName=${requestScope.noteMap.get("USERNAME")}' method="post" onsubmit="return confirm('请确认信息，无法返回')">
				<table align="center" border="1">
		        	...
		        	<tr>
		        		<td><textarea name='note' rows="15" cols="80" wrap="hard">${requestScope.noteMap.get('NOTE')}</textarea></td>
		        	</tr>
		        	<tr>
			...
			<form action='UploadAction?www=${requestScope.noteMap.get("WWW")}&userName=${requestScope.noteMap.get("USERNAME")}' method="post" onsubmit="return confirm('请确认信息，无法返回')" enctype="multipart/form-data">
				<table>
					<tr>
		        		<td>图片名<input type="text" name="filename" value=""/></td>
		        	</tr>
		        	<tr>
